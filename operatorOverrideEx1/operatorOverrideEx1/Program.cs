...
namespace operatorOverrideEx1
{
    class Program
    {
        public struct Complex
        {
            ...
            public static Complex operator +(Complex c1)  //一元
            {
                return c1;
            }
            ...
            public static bool operator true(Complex c1)  //用于if等语句的判断
            {
            ...
            public static Complex operator +(Complex c1, Complex c2)   //二元
            {
            ...
            public static Complex operator *(Complex c1, Complex c2)  //复数乘法
            {
                return new Complex(c1.real * c2.real - c1.imaginary * c2.imaginary,
                    c1.real * c2.imaginary + c1.imaginary * c2.real);
            }
            public static Complex operator *(Complex c, double k)    //数乘
            {
                return new Complex(c.real * k, c.imaginary * k);
            }
            public static Complex operator *(double k, Complex c)   //数乘
            {
                return c * k;
            }
